...
## Introduction
The following code, in combination with field data and NetLogo simulations, was used to conduct analyses and produce graphics for the forthcoming paper: 
...
First, the lithic and scald (surveyed surface exposure) data from Rutherfords Creek are loaded in from CSV files. These can be found at http://wnswap.blogs.auckland.ac.nz/
...
## Get Cortex Ratios for Rutherfords Creek scalds
